...
public class Main {
    public static void main(String[] args) {
        System.out.println("Interiorul metodei statice " + MetodaStatica.metodaStatica());
        System.out.println("Interiorul blocului static " + numar);
        System.out.println("Interiorul clasei statice " + StaticClass.Static.functieStatica());
    }
    ...
    private static int variabilaInafra=30;
    public static class StaticClass {

        static class Static {
            static int variabilaInauntru = 40;
            public static int functieStatica() {
                return variabilaInafra+variabilaInauntru;
            }
        }
    }
